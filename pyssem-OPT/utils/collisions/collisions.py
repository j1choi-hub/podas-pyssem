...
def process_species_pair(args):
    ...
    print("Gamma: ",gammas)
    if scen_properties.fragment_spreading:
        return SpeciesPairClass(s1, s2, gammas, source_sinks, scen_properties, model_type, alt_nums)
    else:
        return SpeciesPairClass(s1, s2, gammas, source_sinks, scen_properties, model_type)
