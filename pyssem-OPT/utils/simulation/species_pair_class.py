...
class SpeciesPairClass:
    def __init__(self, species1, species2, gammas, source_sinks, scen_properties, model_type, fragsMadeDV=None):
        """
        ...
        if model_type == "JASON":
            ...
            self.sigma = (species1.radius * meter_to_km + species2.radius * meter_to_km) ** 2
