...
class ScenarioProperties:
            ...
            for species in species_group:
                ...
                if species.active == True:
                    for shell in range(self.n_shells):
                        y = species_FLM.loc[shell, :].values / time_step / 8
    ...
    def initial_pop_and_launch(self, baseline=False):
        ...
        if baseline:
            ...
            self.x0 = BASE_init_model(self,init_file_path)

        else:
            launch_file_path = os.path.join('utils', 'launch', 'data', 'x0_launch_repeatlaunch_2018to2022_megaconstellationLaunches_Constellations.csv')
    ...
    def build_model(self):
        ...
        for i, species in enumerate(species_list):
            ...
            lambda_expr = species.launch_func(self.scen_times, self.HMid, species, self)
            print("lambda_expr: ", lambda_expr, lambda_expr.shape)
            print("lambda_symb: ", lam_launch)
        ...
        print("EQUATION: ", self.equations[1, :])
    ...
    def run_model(self):
        ...
        if self.time_dep_density:
            ...
            self.density_data = preload_density_data(os.path.join('utils', 'drag', 'dens_highvar_2000_dens_highvar_2000_lookup.json'))
    ...
    def population_shell(self, t, N, full_lambda, equations, times):
        ...
        for i in range(len(N)):
            ...
            if full_lambda[i] is not None:
                increase = []
                for lam_shell in full_lambda[0:self.n_shells]:
