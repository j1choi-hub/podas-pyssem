...
class Model:
    def __init__(self, start_date, simulation_duration, steps, min_altitude, max_altitude, 
                        v_shells, launch_function, integrator, density_model, LC, v_imp=None,
        ...
        try:
            ...
            if not isinstance(v_shells, int) or v_shells <= 0:
                raise ValueError("v_shells must be a positive number.")
    ...
    def create_plots(self):
        ...
        inverted_weights = [1 - min(0.75, nw) for nw in normalized_weights]
